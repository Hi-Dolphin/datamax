...
请生成专业、清晰、用户友好的发布说明，重点突出对用户的价值。"""
        ...
        data = {
            "model": "gpt-3.5-turbo",
            "messages": [{"role": "system", "content": "你是一个专业的软件发布经理，擅长将技术变更转换为用户友好的发布说明。"}, {"role": "user", "content": prompt}],
            "max_tokens": 1000,
            "temperature": 0.3,
        }
...
请生成专业、清晰、用户友好的发布说明，重点突出对用户的价值和影响。"""
        ...
        data = {"contents": [{"parts": [{"text": prompt}]}], "generationConfig": {"temperature": 0.2, "maxOutputTokens": 1500, "topP": 0.8, "topK": 40}}
