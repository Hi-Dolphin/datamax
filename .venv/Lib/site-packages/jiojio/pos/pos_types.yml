model_type:
  a: '形容词'  # 恬静，博，沉甸甸，长长的，匀称，美观，自动，广大，特有，优质
...
rule_type:
  ...
  ru: '俄文'  # Русский язык
  ko: '韩文'  # 한국어
  tel: '电话号码'  # 010-89736182
  url: 'url'  # http://m.weibo.cn/2703294971/44101
deleted_type:
  ...
  nr1: '中文姓氏'  # 汪、李、刘 -> 被合并至 nr
  nrf: '外文人名'  # 斯嘉丽约翰逊，特朗普 -> 被合并至 nr
  vd: '副动词'  # 照常，综合，自主，密闭，统筹，批量化，辅助，免费
  dl: '副词惯用语'  # 接下来，自始至终，为时已晚，整体而言，说到底
  al: '形容词惯用语'  # 跌宕起伏，可圈可点，坚韧不拔，理所当然，无独有偶，光天化日
