...
class DebugContext:
    ...
    def log(self, message: str, **kwargs):
        ...
        if kwargs:
            ...
            logger.debug(
                f"{indent}[{self.context_name}] {message} | {formatted_kwargs}"
            )
        else:
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(self, *args, **kwargs):
            ...
            debug_ctx = DebugContext(
                enabled=debug, context_name=context_name or func.__name__
            )
            ...
            try:
                ...
                debug_ctx.log("Method completed successfully")
                return result
