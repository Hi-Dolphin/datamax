...
class CrawlerCLI:
    ...
    def crawl(
        ...
        **kwargs,
        ...
        try:
            ...
            storage_config = {"type": storage_type, "format": format}
            if output_path:
            ...
            if async_mode:
                # Async crawling
                result = asyncio.run(
                    self._async_crawl(target, storage_adapter, **kwargs)
                )
            else:
                # Sync crawling
    ...
    def crawl_arxiv(
        ...
        **kwargs,
        ...
        try:
            ...
            # Prepare parameters
            crawl_params = {"max_results": max_results, "sort_by": sort_by, **kwargs}
            if category:
        ...
        **kwargs,
        ...
        try:
            ...
            if self.verbose:
                ...
                logger.info(
                    f"Extracted {text_length} characters and {links_count} links"
                )
    ...
    async def _async_crawl(
        self, target: str, storage_adapter, **kwargs
    ) -> Dict[str, Any]:
