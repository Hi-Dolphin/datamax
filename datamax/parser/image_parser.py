...
class ImageParser(BaseLife):
    ...
    def __init__(
        ...
        model_name: str | None = "qwen-vl-plus",
        system_prompt: str | None = "You are a helpful assistant that accurately describes images in detail.",
        use_mllm: bool = False,
    ):
    ...
    def _parse_with_qwen(self, query: str) -> str:
        ...
        messages = [
            ...
            {"role": "user", "content": [{"image": self.file_path}, {"text": query}]},
        ]
        # print(messages)
